...
export class News extends Component {
  ...
  async componentDidMount() {
    ...
    let sideArticlesUrl = 'https://newsapi.org/v2/everything?domains=techcrunch.com,thenextweb.com&apiKey=cdbc3077b6b94db89b1fe640f6b2d4a2';
  ...
  render() {
    return (
      <>
        ...
        <h1 className='  text-center ' style={{marginTop:'85px'}}>Daily-News </h1><hr />
        ...
        {!this.state.loader && 
        <div className="verticalSection flexBox d-flex flex-column">
